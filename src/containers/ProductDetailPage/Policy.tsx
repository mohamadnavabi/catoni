  ...
  const A_FEATURES = [
    {
      color: "bg-red-50",
      name: "ارسال رایگان",
      desc: "برای خریدهای بیشتر از ۱ میلیون تومان",
    ...
    },
    {
      color: "bg-sky-50",
      name: "قابلیت مرجوع",
      desc: "در صورت نارضایتی از کتونی خریداری شده",
      svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      color: "bg-green-50",
      name: "تضمین کیفیت",
      desc: "ضمانت کیفیت تمام کتونی ها",
      svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      desc: "درب منزل پرداخت کنید (در حال حاضر فقط تهران)",
      svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
