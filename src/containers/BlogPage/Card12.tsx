...
import SocialsShare from "components/shared/SocialsShare/SocialsShare";
...
const Card12: FC<Card12Props> = ({ className = "h-full" }) => {
  return (
    ...
    >
      ...
      <SocialsShare className="absolute hidden md:grid gap-[5px] left-4 top-4 opacity-0 z-[-1] group-hover:z-10 group-hover:opacity-100 transition-all duration-300" />

      <div className=" mt-8 pl-10 flex flex-col">
        <h2
